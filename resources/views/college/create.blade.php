...
<div class="row d-flex w-100 ml-1">
  ...
  <form class="container-fluid" action="{{ route('college.submit') }}" method="POST">
    @csrf 
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="course_degree" id="spouseSurname" aria-describedby="emailHelp">
