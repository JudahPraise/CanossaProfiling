            ...
            <tbody>
                @forelse($archives as $archive)
                  <tr>
                    ...
                    <td>{{ $archive->getFullname() }}</td>
                    <td>{{ $archive->email }}</td>
                    <td>{{ $archive->department }}</td>
                    <td>{{ $archive->position }}</td>
                    <td>
                      <a href="{{ route('user.edit-password', $archive->user_id) }}" class="btn btn-primary">Change Password</a>
                      <a href="{{ route('retrieve', $archive->id) }}" class="btn btn-warning">Retrieve</a>
                    </td>
                  </tr>
                @empty
