...
<div class="row d-flex w-100 ml-1">
  ...
  <div class="col d-flex align-items-center ml-0">
    ...
    <form class="container-fluid" action="{{ route('elementary.update', $elementary) }}" method="POST">
      @csrf 
      @method('PUT')

      <div class="form-group">
        <label for="spouseSurname">Name of School (Write in full)</label>
        <input type="text" class="form-control" name="name_of_school" id="spouseSurname" aria-describedby="emailHelp" value="{{ $elementary->name_of_school }}">
      </div>
      ...
      <div class="form-group">
          ...
          <input type="text" class="form-control" name="level_units_earned" id="spouseSurname" aria-describedby="emailHelp" value="{{ $elementary->level_units_earned }}">
      ...
      <div class="form-group d-flex flex-column justify-content-center" >
        ...
        <div class="row" id="period">
          <div class="col-md-6">
            <div class="form-group">
                <label for="childBirthDate">From</label>
                <input type="date" class="form-control" name="graduated_date_from" id="childBirthDate0" aria-describedby="emailHelp" value="{{ $elementary->graduated_date_from }}">
            </div>
          </div>
          ...
          <div class="col-md-6">
              <div class="form-group">
                  <label for="childBirthDate">To</label>
                  <input type="date" class="form-control" name="graduated_date_to" id="childBirthDate0" aria-describedby="emailHelp" value="{{ $elementary->graduated_date_to }}">
              </div>
          </div>
        </div>
      ...
      <div class="form-group">
          ...
          <input type="text" class="form-control" name="academic_reward" id="spouseSurname" aria-describedby="emailHelp" value="{{ $elementary->academic_reward }}">
